...
import (
	...
	"github.com/ServerHealers/kc-sso-ssh/internal/conf"
)
...
Notes:
  ...
  The program will search for this file in the current directory, '/opt/kc-sso-ssh' and '$HOME/.config/config.toml',
...
Arguments:
  ...
  EXAMPLE                 (With otp): echo testpass/717912 | kc-sso-ssh (Only Password): echo testpass | kc-sso-ssh
`, os.Args[0])
}
